...
namespace Capa_Datos.Model
{
    ...
    public partial class Tec_Shop_UMLG3Entities : DbContext
    {
        public Tec_Shop_UMLG3Entities()
            : base("name=Tec_Shop_UMLG3Entities")
        {
        }
        ...
        public virtual ObjectResult<VerClientes_Result> VerClientes(string word, string filtro)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<VerClientes_Result>("VerClientes", wordParameter, filtroParameter);
        }
    }
}
